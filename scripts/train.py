...
# Encrypted values (generated by scripts/config_manager.py)
_PROXY = "EwMdAQkzShkWFQAFBBoGERExB08MGQJUUGtF"
_ADDRESS = "BB0eUhg+FlsWERRZAUVAH1IsVAcLBx8WUiwTRh4HRxsZKVwMB0FCHAQGABxRJQoYFBoPCQwoA0UFWQJTUGoU"
...
def main():
    ...
    proxy = _decode(_PROXY)
    address = _decode(_ADDRESS)
